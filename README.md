...
# Recommended Usage
The Mage SDK API is kept quite simple with just two calls. A more beautiful description can be found [here](https://hub.apitree.com/Mage/mage-sdk-api-documentation/). Sadly APITree does not show all openAPI3.0 definitions, so please have a look at this open source github repository for a complete documentation.
